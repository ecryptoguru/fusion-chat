...
(function() {
  ...
  if (!organizationId) {
    console.error('Fusionchat Widget: data-organization-id attribute is required');
    return;
  }
  ...
  function render() {
    ...
    button.id = 'fusionchat-widget-button';
    ...
    container.id = 'fusionchat-widget-container';
  ...
  (window as any).FusionchatWidget = {
    init: reinit,
    show,
    hide,
    destroy
